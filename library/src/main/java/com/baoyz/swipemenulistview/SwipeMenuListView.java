...
import com.droid.library.widget.RefreshableListView;

/**
 * @author baoyz
 * @date 2014-8-18
 */
public class SwipeMenuListView extends RefreshableListView {
    ...
    public static boolean inRangeOfView(View view, MotionEvent ev) {
        ...
        int x = location[0];
        int y = location[1];
        if (ev.getRawX() < x || ev.getRawX() > (
                x + view.getWidth()) || ev.getRawY() < y
