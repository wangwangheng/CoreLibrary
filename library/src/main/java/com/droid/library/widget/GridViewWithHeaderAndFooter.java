...
public class GridViewWithHeaderAndFooter extends GridView implements AbsListView.OnScrollListener {
    ...
    private static final boolean DEBUG = LibraryConfig.getInstance().isDebug();
    ...
    private void initHeaderGridView() {
        super.setOnScrollListener(GridViewWithHeaderAndFooter.this);
    }

    @Override
    public void setOnScrollListener(OnScrollListener l) {
        if (l != GridViewWithHeaderAndFooter.this) {
...
//            if (DEBUG) {
//                Log.d(LOG_TAG, String.format("getItemViewType: pos: %1$s, result: %2$s", position, type, mCachePlaceHoldView, mCacheFirstHeaderView));
//            }
            return type;
        }
